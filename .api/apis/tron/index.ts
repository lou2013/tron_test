...
export class SDK {
  ...
  ): Promise<FetchResponse<200, types.AccountResourcesUnfreezebalanceResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.AccountResourcesFreezebalanceResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.GetdelegatedresourceaccountindexResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.GettransactioninfobyblocknumResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.CreateshieldedcontractparametersResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.Isshieldedtrc20ContractnotespentResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.Getcanwithdrawunfreezeamount1Response200>> {
  ...
  ): Promise<FetchResponse<200, types.Getdelegatedresourceaccountindexv21Response200>> {
